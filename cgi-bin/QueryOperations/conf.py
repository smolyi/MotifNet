...
class Conf:
    ...
    #server
    root_path = "/media/disk2/users/motifnet/Websites/Product/cgi-bin/" #"/usr/lib/cgi-bin/MotifNetServer/"
    project_dir = "MotifNet"
    Sessions_dir = os.path.join(root_path,"Sessions")
    LogsDir = os.path.join(root_path,"Log")
    ...
    #webpage
    webpageRoot = "/MotifNetWebsite"
    localRootPath = "/var/www/MotifNetWebsite"
